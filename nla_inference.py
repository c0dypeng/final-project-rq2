# ============================================================================
# VENDORED from https://github.com/kitft/nla-inference (nla_inference.py)
# License: Apache-2.0 (see NLA_INFERENCE_LICENSE). Authored by kitft.
#
# Official single-file NLA inference client, vendored (upstream ships it as a
# standalone file, not a package). It reads the checkpoint's nla_meta.yaml and
# handles the trained prompt template, neighbor-verified injection position,
# injection scale, and architecture embed scale automatically. run_rq2.py
# subclasses NLAClient to add logprob support for the M2 perplexity measure.
#
# Pulling updates: re-download from upstream and re-apply this header.
# ============================================================================
